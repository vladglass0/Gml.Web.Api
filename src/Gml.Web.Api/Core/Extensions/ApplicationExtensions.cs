...
public static class ApplicationExtensions
{
        ...
        ServerSettings settings)
    {
        ...
        builder.Services
            ...
            .AddScoped<IJavaRecommendationService, JavaRecommendationService>()
            .AddScoped<IAzulJavaService, AzulJavaService>()
            .AddScoped<IJavaRuntimeService, JavaRuntimeService>()
